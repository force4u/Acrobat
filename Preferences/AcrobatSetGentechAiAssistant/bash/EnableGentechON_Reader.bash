...
#PLISTパス
PATH_PLIST="/Users/${STAT_USR}/Library/Preferences/com.adobe.Reader.plist"
#サンドボックスの場合
#PATH_PLIST_SBX="/Users/${STAT_USR}/Library/Containers/com.adobe.Reader/Data/Library/Preferences/com.adobe.Reader.plist"
...
PATH_DIST_FILE="${PATH_DIST_DIR}/com.adobe.Reader.plist"
...
function DO_SET_FALSE_ARRAY {
  ...
  if [ $? -ne 0 ]; then
    ...
    BOOL_VALUE=$(/usr/libexec/PlistBuddy -c "Add ${STR_SET_PATH} bool true" "$PATH_PLIST")
  else
    #Arrayを削除して
    ...
    /usr/libexec/PlistBuddy -c "Add ${STR_PRE_ARRAY} array" "$PATH_PLIST"
    /usr/libexec/PlistBuddy -c "Add ${STR_PRE_ARRAY}:0 integer 0" "$PATH_PLIST"
    BOOL_VALUE=$(/usr/libexec/PlistBuddy -c "Add ${STR_PRE_ARRAY}:1 bool true" "$PATH_PLIST")
  fi
  /bin/echo "${STR_SET_PATH} : ${BOOL_VALUE} trueを設定しました"
}
