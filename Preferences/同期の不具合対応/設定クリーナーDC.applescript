...
set ocidPlistFilePathURL to ocidLibraryDirPathURL's URLByAppendingPathComponent:("Preferences/com.adobe.Acrobat.Pro.plist") isDirectory:(false)
##NSDATA
...
set listResponse to ocidPlistSerial's propertyListWithData:(ocidPlistData) options:(ocidOption) format:(ocidFormat) |error|:(reference)
if (item 2 of listResponse) = (missing value) then
	log "正常処理"
...
set ocidUserPrefsDirPathURL to ocidApplicatioocidupportDirPathURL's URLByAppendingPathComponent:("Adobe/Acrobat/DC/Reader/PrefSync/Preferences/UserPrefs_Prod") isDirectory:(true)
##
