...
##設定をFALSEに
/usr/libexec/PlistBuddy -c "Set:DC:AVGeneral:IPMEnableAV2AcrobatNewUser:1 bool true" "$STR_PLIST_PATH"
...
if [ "$BOOL_VALUE" = "false" ]; then
##設定をFALSEに
/usr/libexec/PlistBuddy -c "Set:DC:AVGeneral:EnableAV2:1 bool true" "$STR_PLIST_PATH"
...
if [ "$BOOL_VALUE" = "false" ]; then
##設定をFALSEに
/usr/libexec/PlistBuddy -c "Set:DC:FeatureLockDown:EnableAV2Enterprise bool true" "$STR_PLIST_PATH"
...
if [ "$BOOL_VALUE" = "false" ]; then
##設定をFALSEに
/usr/libexec/PlistBuddy -c "Set:DC:AVGeneral:IPMEnableAV2ReaderNewUser:1 bool true" "$STR_PLIST_PATH"
