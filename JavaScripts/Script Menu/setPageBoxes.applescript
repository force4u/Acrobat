...
----+----1----+----2----+-----3----+----4----+----5----+----6----+----7
#
#　メディア　トリム　ブリードの各BOXサイズをCropサイズに変更します
# 
#
...
#####全ページ順に処理
repeat with itemIntNo from 0 to (numAllPage - 1) by 1
	tell application "Adobe Acrobat"
		tell active doc
			do script ("var CropBoxSize = this.getPageBox(\"Crop\", " & itemIntNo & ");")
			set listCropBoxSize to do script ("this.getPageBox(\"Crop\", " & itemIntNo & ");")
			
			do script ("this.setPageBoxes(\"Media\"," & itemIntNo & "," & itemIntNo & ", CropBoxSize);")
			do script ("this.setPageBoxes(\"Bleed\"," & itemIntNo & "," & itemIntNo & ", CropBoxSize);")
			do script ("this.setPageBoxes(\"Trim\"," & itemIntNo & "," & itemIntNo & ", CropBoxSize);")
			do script ("this.setPageBoxes(\"Art\"," & itemIntNo & "," & itemIntNo & ", CropBoxSize);")
			do script ("this.setPageBoxes(\"Crop\"," & itemIntNo & "," & itemIntNo & ", CropBoxSize);")
			
			#	do script ("this.setPageBoxes(\"Media\"," & itemIntNo & "," & itemIntNo & ");")
			#	do script ("this.setPageBoxes(\"Bleed\"," & itemIntNo & "," & itemIntNo & ");")
			#	do script ("this.setPageBoxes(\"Trim\"," & itemIntNo & "," & itemIntNo & ");")
			#	do script ("this.setPageBoxes(\"Art\"," & itemIntNo & "," & itemIntNo & ");")
			#	do script ("this.setPageBoxes(\"Crop\"," & itemIntNo & "," & itemIntNo & ");")
...
tell application "Adobe Acrobat"
	tell active doc
		...
		set numRotation to do script ("this.getPageRotation(numPageNo);")
