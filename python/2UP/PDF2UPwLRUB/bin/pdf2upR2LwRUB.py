...
#########################################■ポジション１
			...
			if (boolH == True):
				...
				numNewXP1 = (numNewW - numWP1) 
				numNewYP1 = 0
			objPageP1.mediabox = RectangleObject((numNewXP1,numNewYP1,numNewW,numNewH))
			objPageP1.cropbox = RectangleObject((numNewXP1,numNewYP1,numNewW,numNewH))
			objPageP1.trimbox = RectangleObject((numNewXP1,numNewYP1,numNewW,numNewH))
			objPageP1.bleedbox = RectangleObject((numNewXP1,numNewYP1,numNewW,numNewH))
			objPageP1.artbox = RectangleObject((numNewXP1,numNewYP1,numNewW,numNewH))
...
#########################################■ポジション２
			...
			if (boolH == True):
				...
				numNewYP2 = 0
				numNewHP2 = numNewH
			objPageP2.mediabox = RectangleObject((numNewXP2,numNewYP2,numWP2,numNewHP2))
			objPageP2.cropbox = RectangleObject((numNewXP2,numNewYP2,numWP2,numNewHP2))
			objPageP2.trimbox = RectangleObject((numNewXP2,numNewYP2,numWP2,numNewHP2))
			objPageP2.bleedbox = RectangleObject((numNewXP2,numNewYP2,numWP2,numNewHP2))
			objPageP2.artbox = RectangleObject((numNewXP2,numNewYP2,numWP2,numNewHP2))
