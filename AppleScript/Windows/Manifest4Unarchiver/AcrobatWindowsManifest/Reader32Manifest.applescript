...
ocidURLComponents's setPath:("/arm-manifests/win/ReaderDCManifest3.msi")
...
##############################
#マニフェスト読み込み
set ocidExtractDirPathURL to ocidSaveDirPathURL's URLByAppendingPathComponent:("ReaderDCManifest3") isDirectory:(true)
#パス
...
ocidOutPutstring's appendString:("Windows版 Readerの32bit版　最新パッチURL\nMSI：インストーラー\nMSP：アップデーターパッチ\nMUI：マルチリンガル対応版\nincr：差分のみアップデート版（軽量）\n\n")
