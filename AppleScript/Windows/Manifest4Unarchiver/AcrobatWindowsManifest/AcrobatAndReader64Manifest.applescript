...
set appPredicate to refMe's NSPredicate's predicateWithFormat_("(SELF CONTAINS %@)", "AcroRdrDCx")
...
ocidOutPutstring's appendString:("Windows版 Acrobat64bit版の最新パッチURL\nMSI：インストーラー\nMSP：アップデーターパッチ\nMUI：マルチリンガル対応版\nincr：差分のみアップデート版（軽量）\n\n")
