...
tell application "Adobe Acrobat"
	...
	tell active doc
		tell PDF Window 1
			...
			if numNowViewPaget > 1 then
				set numBeForePage to numNowViewPaget - 1
				move page numNowViewPaget to before page numBeForePage
			else
				set numBeForePage to numNowViewPaget + 1
				move page numNowViewPaget to after page numBeForePage
			end if
		end tell
	end tell
