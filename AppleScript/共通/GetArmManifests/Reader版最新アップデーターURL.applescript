...
ocidURLComponents's setPath:"/arm-manifests/mac/AcrobatDC/reader/ReaderManifest.arm"
...
#保存パス
set strSaveFileName to "ReaderManifest.pkg" as text
...
#マニフェスト読み込み
#XMLパス
set ocidXmlFilePathURL to ocidSaveDirPathURL's URLByAppendingPathComponent:("UnArchived/ASSET/ReaderManifest.xml") isDirectory:(true)
##############################
#NSDATAに読み込み
set ocidOption to (refMe's NSDataReadingMappedIfSafe)
...
ocidOutPutstring's appendString:("従来版 Acrobat Reader の最新パッチURL\n\n")
