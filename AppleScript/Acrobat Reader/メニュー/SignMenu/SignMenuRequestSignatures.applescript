...
tell application id "com.adobe.Reader"
	...
	try
		execute menu item "SignMenuRequestSignatures" of menu "SignMenu" of application "Adobe Acrobat Reader DC"
	on error
		do script ("app.execMenuItem(\"SignMenuRequestSignatures\");")
	end try
end tell
