...
####################################
###アイコンのパス
set strIconFilePath to "/Applications/Adobe Acrobat Reader DC.app/Contents/Resources/ACR_App.icns" as text
...
set strItemPath to "/Applications/Adobe Acrobat Reader DC.app" as text
####################################
####エイリアスの元ファイル
####################################
