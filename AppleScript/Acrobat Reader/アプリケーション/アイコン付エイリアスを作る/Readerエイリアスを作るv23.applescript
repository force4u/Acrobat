...
####################################
###アイコンのパス
set strIconFilePath to "/Applications/Adobe Acrobat Reader.app/Contents/Resources/ACR_App.icns" as text
...
set strItemPath to "/Applications/Adobe Acrobat Reader.app" as text
####################################
####エイリアスの元ファイル
####################################
