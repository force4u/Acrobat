...
set strPageInfo to (numAllPageNo & "ページ中" & numSelectedPage & "ページ目の情報\n") as text

if numRotation = 0 then
	set theResponse to (strPageInfo & "回転：0\n　OK\n上部が天、下部が地です。") as text
else if numRotation = 90 then
	set theResponse to (strPageInfo & "右回転：90\n　NG \n右が天、左が地です。") as text
else if numRotation = 180 then
	set theResponse to (strPageInfo & "右回転：180\n　NG \n下部が天、上部が地です。") as text
else if numRotation = 270 then
	set theResponse to (strPageInfo & "右回転：270\n　NG \n左が天、右が地です。") as text
end if
try
