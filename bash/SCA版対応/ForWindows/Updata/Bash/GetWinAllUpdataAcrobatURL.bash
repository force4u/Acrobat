...
#保存先のパス
STR_CAB_FILE_PATH="${LOCAL_TMP_DIR}/AcrobatCatalog-DC.cab"
#ダウンロードURL
STR_URL="https://armmf.adobe.com/arm-manifests/win/SCUP/AcrobatCatalog-DC.cab"
#ダウンロード
...
/bin/echo "Windows版 32bit　64bit Acrobat 版 全バージョンアップデータ" | tee -a "$STR_SAVE_FILE_PATH" 
...
#XMLファイルパス
STR_XML_FILE_PATH="${LOCAL_TMP_DIR}/AcrobatManifest/Acrobat_Catalog.xml"
#抽出先
