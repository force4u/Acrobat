...
#保存先のパス
STR_CAB_FILE_PATH="${LOCAL_TMP_DIR}/AcrobatDCManifest3.cab"
#ダウンロードURL
STR_URL="https://armmf.adobe.com/arm-manifests/win/AcrobatDCManifest3.msi"
#ダウンロード
...
/bin/echo "Windows版 32bit　Acrobat製品版アップデータ" | tee -a "$STR_SAVE_FILE_PATH" 
