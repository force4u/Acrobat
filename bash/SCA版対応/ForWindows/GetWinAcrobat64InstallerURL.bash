...
# 64bit版の　製品版Acrobat用です WINDOWS
# 64bit版のマニフェストはSCA(SingleClientApp)　Unified App版なので
# Reader と　Acrobat製品版が混在
...
#保存先のパス
STR_CAB_FILE_PATH="${LOCAL_TMP_DIR}/AcrobatDCx64Manifest3.cab"
#ダウンロードURL
STR_URL="https://armmf.adobe.com/arm-manifests/win/AcrobatDCx64Manifest3.msi"
#ダウンロード
...
/bin/echo "Windows版 64bit　Acrobat製品版アップデータ" | tee -a "$STR_SAVE_FILE_PATH" 
/bin/echo "AcrobatのSCA版　最新バージョンは" "$STR_NEWER_VER" "です" | tee -a "$STR_SAVE_FILE_PATH" 
