...
#保存先のパス
STR_PKG_FILE_PATH="${LOCAL_TMP_DIR}/AcrobatManifest.pkg"
#ダウンロードURL
STR_URL="https://armmf.adobe.com/arm-manifests/mac/AcrobatDC/acrobat/AcrobatManifest.arm"
#ダウンロード
...
STR_OUTPUT_TEXT=""
#テキスト保存先
STR_TEXT_FILE_PATH="${LOCAL_TMP_DIR}/AcrobatManifest/AcrobatManifest.txt"
#XML保存先
STR_XML_FILE_PATH="${LOCAL_TMP_DIR}/AcrobatManifest/ASSET/AcrobatManifest.xml"
#XML読み込み
