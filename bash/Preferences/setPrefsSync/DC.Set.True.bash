...
/usr/libexec/PlistBuddy -c "Set:DC:PrefsSync:PrefsSyncDone:0 1" "$STR_DC_PLIST_FILE_PATH"
/usr/libexec/PlistBuddy -c "Set:DC:PrefsSync:PrefsSyncDone:1 true" "$STR_DC_PLIST_FILE_PATH"
/usr/libexec/PlistBuddy -c "Set:DC:PrefsSync:PrefsSyncUserEnabled:0 1" "$STR_DC_PLIST_FILE_PATH"
/usr/libexec/PlistBuddy -c "Set:DC:PrefsSync:PrefsSyncUserEnabled:1 true" "$STR_DC_PLIST_FILE_PATH"
#
